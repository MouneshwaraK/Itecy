...
public class SpinnerAdapterForStates extends ArrayAdapter<StatesList> {

    private Context context;
    List<StatesList> myObjs;
    LayoutInflater inflater;

    public SpinnerAdapterForStates(Context context, int textViewResourceId, List<StatesList> myObjs) {
    ...
    public StatesList getItem(int position){
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent)
    {
        ...
        main_text.setText(myObjs.get(position).getStateName());
